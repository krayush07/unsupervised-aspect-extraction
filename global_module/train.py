...
class Train:
    def run_epoch(self, session, min_cost, model_obj, dict_obj, epoch_num, reader, lr=0.01, verbose=False):
        ...
        for step, (pos_seq_arr, pos_seq_len, neg_seq_arr, neg_seq_len) \
            ...
            try:
                total_loss, regularized_loss, pos_loss, neg_loss, encoded_rep, decoded_rep, neg_avg_rep, pos_avg_rep, aspect_emb, aspect_dot, attention_weights, pre_attention_scores, filter_layer_representation, _ = session.run([model_obj.total_loss,
                                                                                                                                                               ...
                                                                                                                                                               model_obj.aspect_dot,
                                                                                                                                                                                                                  model_obj.attention_weights,
                                                                                                                                                                model_obj.pre_attention_scores,
                                                                                                                                                                model_obj.filter_layer_representation,
                                                                                                                                                               model_obj.train_op],
                                                                                                                                                              feed_dict=feed_dict)
            except:
                print 'ERROR'
