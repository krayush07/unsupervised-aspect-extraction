...
class Model:
    ...
    def init_pipeline(self):
        ...
        self.attention_weights, self.encoded_rep = self.encoder.encode(self.inp_emb_mat, self.params.EMB_DIM, self.pos_avg_sentence_rep)
    ...
    def compute_loss(self):
        ...
        self.total_loss = self.regularized_loss + tf.reduce_sum(tf.nn.relu(tf.constant(1.0, dtype=tf.float32)
                                                                           - self.pos_loss
