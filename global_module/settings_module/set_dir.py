...
class Directory:
    def __init__(self, mode):
        ...
        self.curr_utility_dir = self.utility_dir + '/reviews'
        ...
        self.glove_path = self.vocab_path + '/w2v_embedding_dict.pkl'
        ...
        self.model_name = '/restaurant.ckpt'  # model name .ckpt is the model extension
        ''' ********** ********* ******** ********* ********* ********* ******** ************* '''''
        ...
        self.test_model_name = '/restaurant.ckpt'
